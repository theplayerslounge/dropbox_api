...
describe DropboxApi::Client, '#delete' do
  ...
  it "won't delete the file if `parent_rev` doesn't match",
     :cassette => 'delete/invalid_parent_rev' do
    expect do
      @client.delete "#{path_prefix}/wont_be_deleted.txt",
