...
describe DropboxApi::Client, '#copy_batch_check' do
  ...
  it 'returns all types of entries', :cassette => 'copy_batch_check/complete' do
    result = @client.copy_batch_check(
      'dbjid:AADOVgzSRvtiBJ9dZaE8VUp07JT-zO7k9TrjEfwnzTfGGDuEi1pTRB2vFufnQfX9Yf-N_tzVl52rGEK4GYI8zzsU'
    )
  ...
  it "returns 'invalid_async_job_id' error",
     :cassette => 'copy_batch_check/invalid_async_job_id' do
    expect do
      @client.copy_batch_check(
        'dbjid:AADOVgzSRvtiBJ9dZaE8VUp07JT-zO7k9TrjEfwnzTfGGDuEi1pTRB2vFufnQfX9Yf-N_tzVl52rGEK4GYI8zzsE'
      )
