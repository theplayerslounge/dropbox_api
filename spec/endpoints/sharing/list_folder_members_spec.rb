...
describe DropboxApi::Client, '#list_folder_members' do
  ...
  it 'lists folder members including member actions',
     :cassette => 'list_folder_members/success_with_actions' do
    result = @client.list_folder_members '1231273663', %i[remove make_owner]
